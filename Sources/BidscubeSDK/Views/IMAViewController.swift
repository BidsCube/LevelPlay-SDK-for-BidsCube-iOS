...
final class IMAViewController: UIViewController {
...
struct IMAVideoAdView: UIViewControllerRepresentable {
    let vastXML: String?
    let vastURL: String?
...
struct AdViewControllerView: UIViewControllerRepresentable {
    let placementId: String
    let adType: AdType
    let callback: AdCallback?
