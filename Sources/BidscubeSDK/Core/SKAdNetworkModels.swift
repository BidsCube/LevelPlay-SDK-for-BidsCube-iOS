...
enum SKAdNetworkFidelityType: Int, Codable {
    case viewThrough = 0
    case storeKitRendered = 1
}

/// SKAdNetwork fidelity object (v2.16.0+)
struct SKAdNetworkFidelity: Codable {
...
struct SKAdNetworkResponseV2_15: Codable {
...
struct SKAdNetworkResponseV2_16: Codable {
    public let version: String
    public let network: String
    public let campaign: Int
    public let itunesitem: Int64
